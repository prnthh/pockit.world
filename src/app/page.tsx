...
const NavButton = ({ children, color = "from-blue-300/50 via-blue-400/50 to-blue-500/50 group-hover:shadow-blue-900/50 border-blue-600" }: { children: React.ReactNode; color?: string }) => {
  ...
  return (
    <div
      ref={cardRef}
      className={`retro-btn bg-gradient-to-b ${color} text-black font-sans font-semibold rounded-3xl shadow-[0_4px_4px_rgba(0,0,0,0.1)] px-4 py-4 transition-all ease-in relative overflow-hidden backdrop-blur-xl border border-gray-500/50 hover:scale-[1.03]`}
      style={{
        width: "320px",
        height: "180px",
